...
def make_components():
    ...
    make_component("object", "glass_pyramid", BuildingCylindrical, (3, 3, 2), (6, 7, 0))
    make_component("object", "glass_pyramid_in_grass", BuildingCylindrical, (3, 3, 2), (6, 7, 0))
    make_component("lawn", "corner", BuildingFull, (6, 6, 0), (10, 0, 0))
    make_component("lawn", "corner_2", BuildingDiagonalAlt, (6, 6, 0), (10, 0, 0))
    make_component("lawn", "edge", BuildingSymmetricalX, (16, 6, 0), (0, 0, 0))
    make_component("lawn", "split", BuildingFull, (16, 6, 0), (0, 10, 0))
