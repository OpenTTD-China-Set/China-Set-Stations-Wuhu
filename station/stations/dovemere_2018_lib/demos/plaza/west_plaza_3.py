...
# Objects
west_square = [
    [center_lawn_edge, offcenter_A_decorated, center, offcenter_A_decorated.R, center_lawn_edge.R],
    [center_toilet_lawn.T, offcenter_B, topiary_2024a_half, offcenter_B.R, center_toilet_lawn.T.R],
]
