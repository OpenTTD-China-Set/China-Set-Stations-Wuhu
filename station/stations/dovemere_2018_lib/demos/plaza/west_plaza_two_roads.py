...
from station.stations.misc import default, road_ground_layout
...
# Road Stops
roadstops = [
    [stair_end, overpass, overpass, overpass_bridge, overpass, overpass, stair_end.R],
    [road_ground_layout] * 3 + [stair_extender_narrow] + [road_ground_layout] * 3,
]
...
west_plaza_two_roads = Demo(
    station + roadstops + west_square,
    "West plaza (two roads, 7×2)",
