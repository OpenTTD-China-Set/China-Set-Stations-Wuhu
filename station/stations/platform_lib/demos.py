...
plat1 = platform_tiles.cns_concrete_elevated_shelter_2.T.lower_tile()
plat1_T = platform_tiles.cns_concrete_elevated_shelter_2.lower_tile()
...
from station.stations.misc import sloped_track, track, slope_2, default
